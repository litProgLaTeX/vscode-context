...
export abstract class Messages {
  public static SERVER_RUNNING = 'ConTeXt language server is running...'

  public static SERVER_STOPPED = 'ConTeXt language server has stopped working!'

  public static SERVER_NOT_INSTALLED_CANCEL = 'Cancel'

  public static SERVER_NOT_FOUND = 'ConTeXt language server not found'
